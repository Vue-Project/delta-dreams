<template>
    <section class="checkIn-reservations">
        <!-- <h1>{{selectedResourceName }}</h1>    <!-- Loader (will be visible until data is fetched) -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <div class="input-group">
                                                                <input type="number" class="form-control" placeholder="0" id="rateAmount" v-model="formAddReservation.units[0].rateAmount" aria-label="number of rateAmount" min="0" ref="rateAmount" :class="{ 'input-error': validationMessages.rateAmount }" />
...
export default {
    ...
    if (hasError) return;
            ...
            const bookingData = {
                ...
                guest_mobile: this.formAddReservation.guestInformation.mobile,
                guest_address: this.formAddReservation.guestInformation.address,
                guest_country: this.formAddReservation.guestInformation.country,
