<template>
      ...
      <div class="sidebar-content">
        ...
        <slot>
          <form
            ref="guestForm"
            id="formGustInfo"
            @submit.prevent="submitFormGuest"
          >
                  ...
                  <div class="row accordion-body pe-0">
                    ...
                    <div class="row mb-lg-3">
                      <div class="col-md-3">
                        ...
                        <input
                          type="text"
                          class="form-control rounded-2 flatpickr-input"
                          placeholder="Select Date"
                          id="flatpickr-date-07"
                          ref="datePicker7"
                          aria-label="input Text to Birth Date"
                          v-model="formGuest.birthDate"
                        />
  ...
  methods: {
    resetValidationMessages() {
      ...
      ["name", "gender", "phone", "idNumber", "idType", "expiryDate"].forEach(
        (field) => {
