                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-check mb-2">
                        ...
                        />
                        <label class="form-check-label" for="formGustInfoMale"
                          >Male</label
                        >
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-check">
                        ...
                        />
                        <label class="form-check-label" for="formGustInfoFemale"
                          >Female</label
                        >
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-check">
                        ...
                        />
                        <label class="form-check-label" for="formGustInfoOther"
                          >Other</label
                        >
                      </div>
                    </div>
