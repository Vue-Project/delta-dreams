<template>
    <div class="add-guest-sidebar">
        <!-- Overlay -->
        <div v-if="localSidebarOpen" class="overlay" @click.stop="handleClose"></div>
                    ...
                    <DropzoneComponent :id="'profile-image'" v-model="formGuest.profileImage" @dropzone-error="handleDropzoneError" />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-lg-3">
                                            ...
                                            <span class="error-message small" v-if="$v.formGuest.idNumber.$error">ID Number is required</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-lg-3">
                                            ...
                                            <span class="error-message small" v-if="$v.formGuest.idType.$error">ID Type is required</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-lg-3">
