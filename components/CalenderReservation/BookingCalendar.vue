    ...
    export default {
        ...
        data() {
            ...
            `,
                    ...
                    resourceAreaWidth: typeof window !== 'undefined' ? (window.innerWidth <= 768 ? '40%' : '13%') : '32%', // Wider on mobile, narrower on desktop
                    slotMinWidth: typeof window !== 'undefined' ? (window.innerWidth <= 768 ? 150 : 70) : 70,
          ...
          `,
            ...
            async handleEventChange(info) {
                try {
                    ...
                    if (event.extendedProps?.is_blocked) {
                        ...
                        const reasonId = event.extendedProps?.block?.reason?.id || event.extendedProps?.reason_id;
            ...
            getUnitNameById(unitId) {
                ...
                for (const building of this.data) {
                    ...
                    const unit = building.units.find(u => u.id.toString() === unitId.toString());
                    if (unit) {
