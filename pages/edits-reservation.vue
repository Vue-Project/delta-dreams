      ...
      <HeaderReservation>
        ...
        <template #content>
            ...
            <div class="row">
              <div class="col-3 p-0" style="border-right: 1px solid #e1e0e3">
                <div class="d-flex justify-content-between">
                  <h6>Room/Folio</h6>
                  <button type="button" class="btn btn-outline-primary waves-effect mb-2 me-2" @click="toggleSidebar('sidebar4')">
                    <i class="fa-solid fa-plus"></i>
                  </button>
                </div>
                <Side :width="'25%'" :isSidebarOpen="activeSidebar === 'sidebar4'" @close-sidebar="toggleSidebar('sidebar4')">
                  <template #SidebarContent>
                    ...
                    <div class="row">
                      <div class="col-md-10 m-auto my-3">
                        <label for="CreditLimit" class="form-label">Registration No</label>
                        <input type="text" class="form-control" placeholder="Registration No" aria-label="Example text with button addon" aria-describedby="button-addon1" />
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-10 m-auto">
              ...
              <div class="col-9">
                <div class="d-flex justify-content-between">
                  <div class="d-flex">
                    <button type="button" class="btn btn-outline-secondary waves-effect me-1" @click="toggleSidebar('sidebar5')">
                      Add Payment
                    </button>
                    <Side :width="'25%'" :isSidebarOpen="activeSidebar === 'sidebar5'" @close-sidebar="toggleSidebar('sidebar5')">
                      <template #SidebarContent>
                        <div class="row">
                          <div class="col-md-10 m-auto">
                            <h3>New Folio</h3>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-10 m-auto my-2">
                            ...
                            <div class="input-group">
                              <button class="w-25 btn btn-outline-secondary dropdown-toggle waves-effect" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                -select-
                              </button>
                              <ul class="dropdown-menu" style="">
                                <li>
                                  <a class="dropdown-item" href="javascript:void(0);">EGP (£)</a>
                                </li>
                                <li>
                                  <a class="dropdown-item" href="javascript:void(0);">EUR (â‚¬)</a>
                                </li>
                              </ul>
                          ...
                          <div class="col-md-10 m-auto my-2">
                            ...
                            <input type="text" class="form-control" placeholder="Add Your Comment" aria-label="Example text with button addon" aria-describedby="button-addon1" />
                          </div>
                        </div>
                        <div class="scbuttons gap-2 d-flex justify-content-end">
                          <button type="submit" class="btn btn-primary waves-effect waves-light">
                    ...
                    <button type="button" class="btn btn-outline-secondary waves-effect me-1" @click="toggleSidebar('sidebar6')">
                      Add Charges
                    </button>
                    <Side :width="'25%'" :isSidebarOpen="activeSidebar === 'sidebar6'" @close-sidebar="toggleSidebar('sidebar6')">
                      <template #SidebarContent>
                        <div class="row">
                          <div class="col-md-10 m-auto">
                            <h3>Add Charge</h3>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4 m-auto my-2">
                            <label for="CreditLimit" class="form-label">Charge Rule</label>
                            <select class="form-select" id="formGustIdentityIdType" aria-label="select ID Type">
                              <option value="" disabled selected>-Select-</option>
                              <option value="option1">Mr.test</option>
                              <option value="option2">test</option>
                    ...
                    <button type="button" class="btn btn-outline-secondary waves-effect me-1" @click="toggleSidebar('sidebar7')">
                      Apply Discount
                    </button>
                    <Side :width="'25%'" :isSidebarOpen="activeSidebar === 'sidebar7'" @close-sidebar="toggleSidebar('sidebar7')">
                      <template #SidebarContent>
                        <div class="row">
                          <div class="col-md-10 m-auto">
                    ...
                    <button type="button" class="btn btn-outline-secondary waves-effect me-1">
                      Folio Operation
                    </button>

                    <div class="btn-group">
                      <button type="button" class="btn btn-outline-secondary dropdown-toggle waves-effect me-1" data-bs-toggle="dropdown" aria-expanded="false">
                        More
                      </button>
                      <ul class="dropdown-menu" style="">
                        <li>
                          <a class="dropdown-item" href="javascript:void(0);">Adjustment</a>
                        </li>
                        <li>
                          <a class="dropdown-item" href="javascript:void(0);">Room Charges</a>
                        </li>
                        <li>
                          <a class="dropdown-item" href="javascript:void(0);">Transfer</a>
                        </li>
                        <li>
                          <a class="dropdown-item" href="javascript:void(0);">Split Folio</a>
                        </li>
                        <li>
                          <a class="dropdown-item" href="javascript:void(0);">Upload Files</a>
                        </li>
                        <li>
                          <a class="dropdown-item" href="javascript:void(0);">Meal Plan</a>
                        </li>
                        <li>
                          <a class="dropdown-item" href="javascript:void(0);">Inclusion</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="d-flex justify-content-end mt-2">
                    <span class="me-2"><i class="fa-solid fa-square me-2" style="color: #ffd43b"></i>UnPosted</span>
                    <span class="me-2"><i class="fa-solid fa-square me-2" style="color: #c3c6d1"></i>Posted</span>
                ...
                <table class="datatables-basic table dataTable no-footer dtr-column mt-3" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="height: 60vh">
                  <thead>
              ...
              <div class="col-3 px-0" style="border-right: 1px solid #e1e0e3">
                <div class="d-flex justify-content-between">
                  ...
                  <div class="pe-2">
                    ...
                    <button type="button" class="btn btn-outline-primary waves-effect mb-2" @click="toggleSidebar('sidebar12')">
                      <i class="fa-solid fa-plus"></i>
                    </button>
                    <Side :isSidebarOpen="activeSidebar === 'sidebar12'" @close-sidebar="toggleSidebar('sidebar12')">
                      <template #SidebarContent>
                ...
                <form id="formGustInfo">
                  <div class="row p-3 mb-5">
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="mb-3">
                            <label for="formGustIdentityIdType" class="col-form-label">Guest Type</label>
                            <select class="form-select" id="formGustIdentityIdType" aria-label="select ID Type">
                              <option value="" disabled selected>-Select-</option>
                    ...
                    <div class="row mt-2">
                      <div class="col-md-3">
                        <label for="countryGuest" class="col-form-label">Nationality</label>
                        <input class="form-control" type="text" id="countryGuest" placeholder="country" aria-label="input Text to Gust country" />
                      </div>
                      <div class="col-md-3">
                        <label for="formGustInfoState" class="col-form-label">Company</label>
                        <input class="form-control" type="text" id="formGustInfoState" placeholder="state" aria-label="input Text to Gust state" />
                      </div>
                      <div class="col-md-3">
                      ...
                      <div class="col-md-3">
                        <label for="formGustInfoZip" class="col-form-label">Registration No
                        </label>
                        <input class="form-control" type="text" id="formGustInfoZip" placeholder="Zip" aria-label="input Text to Gust Zip" />
                      </div>
                    </div>
                      ...
                      <div id="accordionOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample" style="">
                        ...
                        <div class="row accordion-body">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                              <label for="BirthCity" class="col-form-label">Birth City</label>
                              <input class="form-control" type="text" id="formGustIssuingCity" placeholder="City" aria-label="Enter Issuing City" />
                            </div>
                            <div class="col-md-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-9 d-flex justify-content-end">
                      <button type="button" class="btn btn-outline-primary waves-effect me-1">
                        Pick Up / Drop off
                      </button>
                      <button type="button" class="btn btn-outline-primary waves-effect me-1">
                        Add Signature
                      ...
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" style="">
                          <li>
                            <a class="dropdown-item" href="javascript:void(0);">Print GR Card</a>
                          </li>
                        </ul>
                      </div>
                      <button type="button" class="btn btn-outline-primary waves-effect" disabled>
          ...
          <div class="tab-pane fade" id="form-tabs-RoomCharges" role="tabpanel">
            <div class="d-flex">
              <button type="button" class="btn btn-outline-secondary waves-effect mb-2 me-3" @click="toggleSidebar('sidebar9')">
                Update Details
              </button>
              <Side :width="'35%'" :isSidebarOpen="activeSidebar === 'sidebar9'" @close-sidebar="toggleSidebar('sidebar9')">
                <template #SidebarContent>
                  <div class="row">
                    <div class="col-md-10 m-auto">
              ...
              <button type="button" class="btn btn-outline-secondary waves-effect mb-2" @click="toggleSidebar('sidebar10')">
                Apply Discount
              </button>
              <Side :isSidebarOpen="activeSidebar === 'sidebar10'" @close-sidebar="toggleSidebar('sidebar10')">
                <template #SidebarContent>
          ...
          <div class="tab-pane fade" id="form-tabs-CreditCard" role="tabpanel">
            ...
            <Side :isSidebarOpen="activeSidebar === 'sidebar11'" @close-sidebar="toggleSidebar('sidebar11')">
              <template #SidebarContent>
