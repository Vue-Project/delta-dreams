                    ...
                    <div class="ms-auto me-3">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
                            <div class="offcanvas-header">
                                <h5 id="offcanvasEndLabel" class="offcanvas-title">Search</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-10 m-auto">
                                        ...
                                        <div class="form-check mt-3">
                                            ...
                                            <label class="form-check-label" for="UnassignedRoom">Show Unassigned Rooms</label>
                                        </div>
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" value="" id="UnassignedRoom" checked="" />
                                            <label class="form-check-label" for="HotelCollect">Hotel Collect</label>
                                        </div>
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" value="" id="HotelCollect" checked="" />
                                            <label class="form-check-label" for="Arrival">Channel Collect and with Deposit</label>
                                        </div>
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" value="" id="Arrival" checked="" />
                                            <label class="form-check-label" for="Arrival">Without Deposit</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-if="activeTab === 'arrivals'">
                                <div class="row">
                                    <div class="col-md-10 m-auto">
                                        ...
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" value="" id="Arrival" checked="" />
                                            <label class="form-check-label" for="Arrival">Guest Checked in Details</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-if="activeTab === 'departures'">
                                <div class="row">
                                    <div class="col-md-10 m-auto">
                                        ...
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" value="" id="HotelCollect" checked="" />
                                            <label class="form-check-label" for="Arrival">Guest Checked Out Today</label>
                                        </div>
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" value="" id="HotelCollect" checked="" />
                                            <label class="form-check-label" for="Arrival">Past Guest Check outs</label>
                                        </div>
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" value="" id="HotelCollect" checked="" />
                                            <label class="form-check-label" for="Arrival">Guest With Balance</label>
                                        </div>
                                    </div>
                                </div>
                                <h1>departures</h1>
                            ...
                            <div class="gap-2 d-flex justify-content-end resetSearch">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="card-title mb-0">
                                                    ...
                                                    <div>
                                                        <i class="fa-solid fa-person m-2"></i>
                                                        3
                                                        <i class="fa-solid fa-baby m-2"></i>
                                                        2
                                                    </div>
                                                </div>
                                            </div>
